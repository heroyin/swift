...
void DateTime::gettimeofday(struct base::consts::timeval* tv) {
#if ELPP_OS_WINDOWS
  if (tv != nullptr) {
...
std::string DateTime::getDateTime(const char* format, const base::SubsecondPrecision* ssPrec) {
	struct base::consts::timeval currTime;
  gettimeofday(&currTime);
  return timevalToString(currTime, format, ssPrec);
}

std::string DateTime::timevalToString(struct base::consts::timeval tval, const char* format,
...
unsigned long long DateTime::getTimeDifference(const struct base::consts::timeval& endTime, const struct base::consts::timeval& startTime,
  ...
  // milliseconds
  auto conv = [](const struct base::consts::timeval& tim) {
...
struct ::tm* DateTime::buildTimeInfo(struct base::consts::timeval* currTime, struct ::tm* timeInfo) {
#if ELPP_OS_UNIX
...
const base::type::string_t PerformanceTracker::getFormattedTimeTaken(struct base::consts::timeval startTime) const {
