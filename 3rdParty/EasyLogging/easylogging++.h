...
class DateTime : base::StaticClass {
 public:
  ...
  /// @param [in,out] tv Pointer that gets updated
	 static void gettimeofday(struct base::consts::timeval* tv);
  ...
  static std::string timevalToString(struct base::consts::timeval tval, const char* format,
  ...
  static unsigned long long getTimeDifference(const struct base::consts::timeval& endTime, const struct base::consts::timeval& startTime,
      base::TimestampUnit timestampUnit);


 private:
	 static struct ::tm* buildTimeInfo(struct base::consts::timeval* currTime, struct ::tm* timeInfo);
...
class PerformanceTrackingData {
 public:
  ...
  inline const struct base::consts::timeval* startTime(void) const;
  inline const struct base::consts::timeval* endTime(void) const;
  inline const struct base::consts::timeval* lastCheckpointTime(void) const;
...
class PerformanceTracker : public base::threading::ThreadSafe, public Loggable {
 ...
 private:
  ...
  bool m_enabled;
  struct base::consts::timeval m_startTime, m_endTime, m_lastCheckpointTime;
  ...
  const base::type::string_t getFormattedTimeTaken(struct base::consts::timeval startTime) const;
...
inline const struct base::consts::timeval* PerformanceTrackingData::startTime() const {
  return const_cast<const struct timeval*>(&m_performanceTracker->m_startTime);
}
inline const struct base::consts::timeval* PerformanceTrackingData::endTime() const {
  return const_cast<const struct timeval*>(&m_performanceTracker->m_endTime);
}
inline const struct base::consts::timeval* PerformanceTrackingData::lastCheckpointTime() const {
	return const_cast<const struct base::consts::timeval*>(&m_performanceTracker->m_lastCheckpointTime);
}
